 ...
 * @author MasobaPC
 */
public class AñadirComicBiblioteca extends javax.swing.JFrame {

    /**
     * Creates new form AñadirComicBiblioteca
     */
    public AñadirComicBiblioteca() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirComicBiblioteca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AñadirComicBiblioteca().setVisible(true);
            }
        });
    }
