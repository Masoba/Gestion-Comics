 ...
 * @author MasobaPC
 */
public class Deseados extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deseados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void ordenarAlfabeticamente() {
        ...
        Tomo[] tomos = c.cargarComicsDeseados();
        ...
        for (i = 0; i < tomos2.length - 1; i++) {
            for (j = tomos2.length - 1; j > i; j--) {
                try {
                    ...
                    Logger.getLogger(Deseados.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        eliminarBiblioteca();
