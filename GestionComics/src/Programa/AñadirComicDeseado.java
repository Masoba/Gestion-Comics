 ...
 * @author MasobaPC
 */
public class AñadirComicDeseado extends javax.swing.JFrame {

    /**
     * Creates new form AñadirComicBiblioteca
     */
    public AñadirComicDeseado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbxEditorialUSA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Dark Horse", "DC", "Image", "MacMillan", "Marvel", "Vertigo", "Otra" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 2;
        ...
        cbxEditorialESP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "deBolsillo", "ECC", "Ivrea", "MilkWay", "Norma", "Panini", "Planeta", "Otra" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.gridwidth = 2;
    ...
    private void btnAñadirComicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAñadirComicActionPerformed
        ...
        if(c.guardarTomo(tomo)== 1){
            if(JOptionPane.showConfirmDialog(this, "Cómic añadido satisfactoriamente a tu Biblioteca. ¿Desea añadir otro cómic?","Añadido",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirComicDeseado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AñadirComicDeseado().setVisible(true);
            }
        });
    }
