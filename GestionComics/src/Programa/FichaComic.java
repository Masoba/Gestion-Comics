 ...
 * @author MasobaPC
 */
public class FichaComic extends javax.swing.JFrame {
    ...
    private void btnBorrarComicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarComicActionPerformed
        if (JOptionPane.showConfirmDialog(this, "¿Seguro que deseas borrar este cómic de tu Biblioteca?") == JOptionPane.YES_OPTION) {
            ...
            if (c.borrarComic(this.IDTomo) == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FichaComic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FichaComic(1).setVisible(true);
            }
        });
    }
    ...
    private void cargarComic() {
        ...
        try {
            ...
            Logger.getLogger(FichaComic.class.getName()).log(Level.SEVERE, null, ex);
        }
